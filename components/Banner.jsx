	...
	<section id="banner" className="major">
		<div className="inner">
			<header className="major">
				...
				<h1>Empower Change, <br /> Transform Relationships. <br /> Experience therapy that delivers.</h1>
			</header>
			<div className="content">
				...
				<p>Personalized, Compassionate, Expert Therapy Services for Individuals, Couples, and Families.</p>
				<ul className="actions">
					<li><a href="#contact" className="button next scrolly">Start your better life now</a></li>
				</ul>
			</div>
			<br />
			{/* <h4>A roadmap from repetitive, stuck cycles to hopeful futures. Coping strategies for your relationship’s unique challenges.</h4> */}
		</div>
	</section>
)
