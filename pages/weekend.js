...
export default () => (
    <Layout>
        <Head>
            ...
            <meta name="description" content="Weekend intensive session are available for faster progress, scheduling convenience." />
        </Head>
        ...
        <div id="main" className="alt">
            <section id="one">
                <div className="inner">
                    ...
                    <p>You will experience guided conversations with your partner in a safe process to deepen your intimacy and trust. You will be given structured exercises, a calming environment, helpful media, and tools to improve your bond. I will guide you out of stuck places if you get stalled, as you learn new ways to bring closeness back.</p>
                    <p>The couples intensive process is based on the book “HOLD ME TIGHT” by Dr. Sue Johnson, internationally acclaimed attachment science researcher and the pioneering developer of EFT — Emotionally Focused Couples Therapy.</p>
                    <p>If you desire lasting love and strong bonds, contact us today to get started.</p>
                </div>
            </section>
        </div>
    </Layout>
