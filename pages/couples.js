            ...
            <section id="one">
                <div className="inner">
                    <header className="major">
                        ...
                        <blockquote>Develop a lasting, secure bond that provides joy through life's triumphs, and shelter through tough times. Help for deeper communication, intimacy, marital crisis, and marital enrichment. My 25 years experience working with couples, advanced training in both attachment-based couple therapy - Emotionally Focused Therapy (EFT) with the Gottman Institute, puts your relationships in safe hands.</blockquote>
                    </header>
                    <span className="image main"><img src="/images/header-couples.jpg" alt="" /></span>
