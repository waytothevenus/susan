	...
	<div id="main" className="alt">
		<section id="one">
			<div className="inner">
				...
				<p>Even the most distressed families can restore their love relationships to renewed intimacy and marital satisfaction. I use the most highly regarded, evidence–based therapy approach available in North America. Based on 25 years of research by esteemed marriage expert John Gottman, PhD (The Gottman Institute, University of Washington) and the processes of Emotionally–Focused Therapy developed by eminent attachment science researcher, <b>Sue Johnson, PhD</b>.</p>
